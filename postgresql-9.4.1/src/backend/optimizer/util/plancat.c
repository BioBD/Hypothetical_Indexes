...
#include "catalog/pg_type.h" //* HYPOTHETICAL INDEX SELF TUNING GROUP - PUC-RIO - 2015 - To calculate column size */
				  ...
				  RelOptInfo *rel)
{
	...
	if (hasindex)
	{
        ...
        /*
         * HYPOTHETICAL INDEX SELF TUNING GROUP - PUC-RIO - 2015
         *
         * we have to say if we are looking for hypothetical index or not.
         * That information is in the Query structure of parse
        */
        indexoidlist = RelationGetIndexList_PUC(relation,root->parse->hypothetical);
		...
		foreach(l, indexoidlist)
		{
            ...
            /**
            * HYPOTHETICAL INDEX
            * SELF TUNING GROUP - PUC-RIO - 2015
            *
...
// marca de error
			if (info->relam == BTREE_AM_OID)
			{
                 ...
                 * SELF TUNING GROUP - PUC-RIO - 2015
                 *
                 * Hypothetical Index don't have height
                 */
                if(!index->indishypothetical){
