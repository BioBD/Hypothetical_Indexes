...
CATALOG(pg_index,2610) BKI_WITHOUT_OIDS BKI_SCHEMA_MACRO
{
    ...
    bool		indishypothetical; /* is this index hypothetical? * HYPOTHETICAL INDEX * SELF TUNING GROUP - PUC-RIO - 2015 */
...
#define Anum_pg_index_indishypothetical 9      /*Puc Rio 2015 -- Compiler directive to hypothetical index indexing in the FormData_pg_index struct*/
