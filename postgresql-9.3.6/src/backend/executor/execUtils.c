 ...
 *
 * we add the function ExecOpenIndices_PUC to ensure that codes without knowledge of hypothetical index remain equals
 */
void
ExecOpenIndices(ResultRelInfo *resultRelInfo){
    return ExecOpenIndices_PUC(resultRelInfo, false);
}
void
ExecOpenIndices_PUC(ResultRelInfo *resultRelInfo, bool hypothetical)
{
