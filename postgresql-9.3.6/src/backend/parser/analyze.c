...
transformStmt(ParseState *pstate, Node *parseTree)
{
    ...
    /*PUC Rio 2015 -- Set hypothetical info to the result structure*/
    if(IsA(parseTree,ExplainStmt)){
        ExplainStmt * expl=(ExplainStmt *) parseTree;
        ((Query *)(((ExplainStmt *)result->utilityStmt)->query))->hypothetical=expl->hypothetical;
        result->hypothetical=expl->hypothetical;
    }
    else{
        result->hypothetical=false;
    }
