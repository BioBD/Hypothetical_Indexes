...
d token types.  These are hard-wired into the "flex" lexer.
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	GLOBAL GRANT GRANTED GREATEST GROUP_P
        ...
        HANDLER HAVING HEADER_P HOLD HOUR_P HYPOTHETICAL /* HYPOTHETICAL INDEX SELF TUNING GROUP - PUC-RIO - 2015 */
...
IndexStmt:	CREATE HYPOTHETICAL opt_unique INDEX opt_concurrently opt_index_name
...
/* HYPOTHETICAL INDEX SELF TUNING GROUP - PUC-RIO - 2015 */
ExplainStmt:
                EXPLAIN HYPOTHETICAL ExplainableStmt
				{
